...
class Testconnectors137070ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS137070_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS137070_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS137070"
